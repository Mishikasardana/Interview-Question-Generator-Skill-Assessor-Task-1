"""
Configuration loader for the Answer Evaluation Module.
...
Purpose:
    ...
    environment variables as every other module in the project
...
Outputs:
    Immutable configuration values consumed by ``evaluator.py``.

Example usage:
    >>> from answer_evaluation.config import get_glm_api_key
...
def get_glm_api_key() -> str:
    ...
    Raises:
        AnswerEvaluationError: If neither is set.
    """
